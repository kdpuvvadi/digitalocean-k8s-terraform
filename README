# k8s Cluster on Digital Ocean with Terraform

## Installing Terraform

To install terraform, follow installation instructions [here](https://blog.puvvadi.me/posts/terraform-azure-getting-started#installing-terraform).
